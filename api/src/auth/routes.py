...
async def create_user_Account(
    ...
    """
    Create user account using email, username, name
    params:
        user_data: UserCreateModel
    """
...
@auth_router.get("/me", response_model=UserProjectsModel)
...
@auth_router.post("/users", response_model=list[UserReadModel])
...
async def delete_user(user_uid: str, session: AsyncSession = Depends(get_session)):
    return await user_service.delete_user_by_uid(user_uid, session)
